...
pixi add topologicpy
# for installing globally
pixi global install topologicpy
```
...
It is possible to list all of the versions of `topologicpy` available on your platform:
...
```
pixi search topologicpy --channel conda-forge
```
